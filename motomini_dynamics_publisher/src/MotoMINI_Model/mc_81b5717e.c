...
#include "stdlib.h"
void*mc_4NUC47j4aJxHBwMhDbTZV0(int32_T n,size_t size){return(malloc((((n)>(1))
?(n):(1))*size));}void*mc_y1rJRp21YhZDKCX1eSUsS1(int32_T n,size_t size){return
(calloc((((n)>(1))?(n):(1)),size));}void*mc_LxZ4GcxGp0D4_SX8kV0GM_(void*
pm_KYlcoOk9rSSGYswizhYqZ2){if(pm_KYlcoOk9rSSGYswizhYqZ2)free(
pm_KYlcoOk9rSSGYswizhYqZ2);return(NULL);}void*mc_Fzj5zJ9NnkLsRO10o4n_t1(void*
pm_KYlcoOk9rSSGYswizhYqZ2,int32_T n,size_t size,int32_T*
mc_YBSj3VRtODEIq_zyObpWg2){void*mc_cRXfK9vXWWlGdtSU_OOj6_;
mc_cRXfK9vXWWlGdtSU_OOj6_=realloc(pm_KYlcoOk9rSSGYswizhYqZ2,(((n)>(1))?(n):(1)
)*size);*mc_YBSj3VRtODEIq_zyObpWg2=(mc_cRXfK9vXWWlGdtSU_OOj6_!=NULL);return((*
mc_YBSj3VRtODEIq_zyObpWg2)?mc_cRXfK9vXWWlGdtSU_OOj6_:pm_KYlcoOk9rSSGYswizhYqZ2
);}
