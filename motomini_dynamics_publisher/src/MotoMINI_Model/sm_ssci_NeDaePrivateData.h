...
);CStateManager*(*mClone)(const CStateManager*);void(*mDestroy)(CStateManager*
);CStateManagerData*mData;};struct SmBoundedSetTag{size_t mBound;unsigned char
*mFlags;};typedef struct SmBoundedSetTag SmBoundedSet;void
sm_core_SmBoundedSet_create(SmBoundedSet*set,size_t bound);void
sm_core_SmBoundedSet_copy(SmBoundedSet*copy,const SmBoundedSet*orig);void
...
;size_t mStateSize;size_t mContinuousStateSize;size_t mNumStages;size_t
mNumConstraints;size_t mNumAllConstraintEquations;SmSizePairVector
mJointToStageIdx;SmSizeTVector mPrimitiveIndices;SmSizePairVector mStateOffsets
;SmSizePairVector mDofOffsets;SmSizeTVector mFlexibleStages;SmSizeTVector
mRemodIndices;SmSizeTVector mEquationsPerConstraint;SmIntVector
mRunTimeEnabledEquations;SmSizeTVector mDofToVelSlot;SmSizeTVector
mConstraintDofs;SmSizeTVector mConstraintDofOffsets;
...
motionData,double*stateVector,void*neDiagMgr);void(*mComputeDiscreteState)(
const void*mech,const struct RuntimeDerivedValuesBundleTag*
runtimeDerivedValuesBundle,double*stateVector);void(*mAdjustPosition)(const
void*mech,const double*dofDeltas,double*stateVector);void(*
mPerturbJointPrimitiveState)(const void*mech,size_t stageIdx,size_t
primitiveIdx,double magnitude,boolean_T doPerturbVelocity,double*stateVector);
void(*mPerturbFlexibleBodyState)(const void*mech,size_t stageIdx,double
magnitude,boolean_T doPerturbVelocity,double*stateVector);void(*
mComputeDofBlendMatrix)(const void*mech,size_t stageIdx,size_t primitiveIdx,
...
constraintIdx,const double*stateVector,const double*motionData,double*error);
size_t(*mComputeAssemblyJacobian)(const void*mech,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,size_t constraintIdx,
boolean_T forVelocitySatisfaction,const double*stateVector,const double*
motionData,double*J);size_t(*mComputeFullAssemblyJacobian)(const void*mech,
...
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,size_t constraintIdx,
const double*motionData);PmfMessageId(*mConvertStateVector)(const void*asmMech
,const struct RuntimeDerivedValuesBundleTag*asmRuntimeDerivedValuesBundle,
const void*simMech,const double*asmStateVector,double*simStateVector,void*
neDiagMgr);void(*mConstructStateVector)(const void*mech,const double*
solverStateVector,const double*u,const double*uDot,const double*
discreteStateVector,double*fullStateVector);void(*mExtractSolverStateVector)(
const void*mech,const double*fullStateVector,double*solverStateVector);int(*
mIsPositionViolation)(const void*mech,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,const int*
constraintEqnEnableFlags,const double*stateVector);int(*mIsVelocityViolation)(
const void*mech,const struct RuntimeDerivedValuesBundleTag*
runtimeDerivedValuesBundle,const int*constraintEqnEnableFlags,const double*
stateVector);PmfMessageId(*mProjectStateSim)(const void*mech,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,const int*
constraintEqnEnableFlags,const double*inputVector,double*stateVector,void*
neDiagMgr);void(*mComputeConstraintError)(const void*mech,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,const double*
stateVector,double*error);const void*mMech;};typedef struct
SmMechanismDelegateTag SmMechanismDelegate;struct
SmMechanismDelegateScratchpadTag{SmBoundedSet mPosRequired,mPosDesired,
...
mStartState;SmRealVector mTestState;SmRealVector mFullStateVector;SmRealVector
mJacobianRowMaj;SmRealVector mJacobian;SmRealVector mJacobianPrimSubmatrix;
SmRealVector mConstraintNonhomoTerms;SmRealVector mConstraintError;
SmRealVector mBestConstraintError;SmRealVector mDeltas;SmRealVector mSvdWork;
SmRealVector mLineSearchScaledDeltaVect;SmRealVector mLineSearchTestStateVect;
SmRealVector mLineSearchErrorVect;SmRealVector mActiveDofVelsVect;SmRealVector
mVelSystemRhs;SmRealVector mMotionData;};void
...
runtimeDerivedValuesBundle,size_t numTargets,const struct CTargetTag*cTargets,
double*stateVector,void*neDiagMgr);PmfMessageId
sm_core_computeStateVectorCustom(const SmMechanismDelegate*mechDelegate,const
struct RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,size_t
numTargets,const struct CTargetTag*cTargets,boolean_T doPosSatPhase1,boolean_T
doVelSat,double*stateVector,void*neDiagMgr);unsigned int sm_core_checkAssembly
(const SmMechanismDelegate*mechDelegate,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,const double*
stateVector,SmSizeTVector*posViolationConstraintIndices,SmSizeTVector*
...
SmMechanismDelegate*mechDelegate,const struct RuntimeDerivedValuesBundleTag*
runtimeDerivedValuesBundle,const double*inputVector,const double*
inputDotVector,const double*discreteStateVector,double*solverStateVector,void*
neDiagMgr);void sm_core_computeRedundantConstraintEquations(
SmMechanismDelegate*mechDelegate,const struct RuntimeDerivedValuesBundleTag*
runtimeDerivedValuesBundle);struct RuntimeDerivedValuesBundleTag{SmRealVector
mDoubles;SmIntVector mInts;};typedef struct RuntimeDerivedValuesBundleTag
RuntimeDerivedValuesBundle;void sm_core_RuntimeDerivedValuesBundle_create(
RuntimeDerivedValuesBundle*bundle,size_t nDoubles,size_t nInts);void
...
mInputVectorSize;size_t mOutputVectorSize;size_t mNumConstraintEqns;boolean_T
mDoCheckDynamics;NeChecksum mChecksum;PmRealVector mAssemblyFullStateVector;
PmRealVector mSimulationFullStateVector;size_t mNumInternalTargets;size_t
...
mParamAssertMessageIds;PmBoolVector mParamAssertIsWarnings;size_t
mNumVarScalars;PmCharVector*mVarFullPaths;PmCharVector*mVarObjects;size_t
mNumRtpRootVars;PmIntVector mRtpRootVarRows;PmIntVector mRtpRootVarCols;
PmCharVector*mRtpFullPaths;size_t mNumRuntimeRootVarScalars;PmRealVector
...
mPAssertFcn;NeDaeMethod mDerivativeFcn;NeDaeMethod mOutputFcn;NeDaeSolve
mProjectionFcn;NeDaeSolve mProjectionMaybeFcn;NeDaeSolve mCheckFcn;NeDaeSolve
mAssemblyFcn;void(*mSetupLoggerFcn)(const NeDae*,NeLoggerBuilder*);int32_T(*
mLogFcn)(const NeDae*,const NeSystemInput*,PmRealVector*);NeDaeLinearizeFcn
mResidualsFcn;NeDaeLinearizeFcn mLinearizeFcn;void(*mGenerateFcn)(const NeDae*
,const NeCgParams*,NeCgResults*);struct LiveSmLink*mLiveSmLink;void(*
