...
matrixMultiply(uint32_T m,uint32_T k,uint32_T n,const double*A,const double*B,
double*C);void matrixMultiplyDynamicSize(uint32_T maxM,uint32_T maxK,uint32_T
maxN,uint32_T m,uint32_T k,uint32_T n,const double*A,const double*B,double*C);
void matrixMultiplyStrided(uint32_T m,uint32_T k,uint32_T n,uint32_T AStride,
...
subtractMatrixVectorProduct(uint32_T m,uint32_T n,const double*A,const double*
x,double*y);void subtractMatrixVectorProductDynamicSize(uint32_T maxM,uint32_T
maxN,uint32_T m,uint32_T n,const double*A,const double*x,double*y);double
computeQuadraticTerm(uint32_T n,const double*M,const double*u,const double*v);
void geSolve2x2(const real_T A[4],const real_T b[2],real_T x[2]);int32_T
factorSymmetricPosDef(real_T*A,uint32_T n,real_T*work);void
